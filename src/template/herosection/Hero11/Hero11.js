...
const Hero11Array = [
  { id: 0, name: 'Title', settingId: 121, value: "We Make Easier with Jetson AI" },
...
const Hero11 = ({sectionId}) => {
  ...
  return (
    <section className="w-full flex items-center justify-center min-h-screen overflow-hidden bg-gradient-to-b from-[#10111D] to-green-300 relative text-white"  style={{backgroundImage:`url(${Image})`,backgroundColor:BackgroundColor}}>
