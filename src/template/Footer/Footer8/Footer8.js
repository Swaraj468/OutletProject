    ...
    <footer className="bg-gray-100">
      <div className="max-w-screen-lg px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
        ...
        <div className="p-5">
          ...
          <a href="/#" className="my-3 block">Documentation</a>
          <a href="/#" className="my-3 block">Tutorials</a>
        ...
        <div className="p-5">
          ...
          <a href="/#" className="my-3 block">Help Center</a>
          <a href="/#" className="my-3 block">Privacy Policy</a>
          <a href="/#" className="my-3 block">Conditions</a>
        </div>
        <div className="p-5">
          ...
          <a href="/#" className="my-3 block">contact@company.com</a>
        </div>
      </div>
        ...
        <div className="flex pb-5 px-3 m-auto pt-5 border-t text-gray-800 text-sm flex-col max-w-screen-lg items-center">
          <div className="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
            ...
            <a href="/#" className="w-6 mx-1">
              ...
              >
                <path d="M24,12c0,6.627 -5.373,12 -12,12c-6.627,0 -12,-5.373 -12,-12c0,-6.627
            ...
            <a href="/#" className="w-6 mx-1">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="M7.3,0.9c1.5,-0.6 3.1,-0.9 4.7,-0.9c1.6,0 3.2,0.3 4.7,0.9c1.5,0.6 2.8,1.5
