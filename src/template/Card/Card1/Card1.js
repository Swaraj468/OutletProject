...
const Card1Array = [
  ...
  { id: 1, name: "Font Gap Title", settingId: 123, value: "large" },
  {id:2, name:'Color Picker',settingId:124,value:''},
   {id:3, name:'font Size',settingId:121,value:'2rem'},
   {id:4, name:'Image',settingId:125,value:''},
];
const Card1=()=> {
  return (
