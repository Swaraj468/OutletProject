    ...
    },
    {
      ...
      svg: (
        <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white">
          {/* ... You can paste the full IRRIGATION & DRAINAGE icon path here */}
          <path d="M12 0C11.0532 0 ..." fill="#F5F5FC" />
          {/* Trimmed for brevity */}
        </svg>
      )
    },
    {
      ...
      svg: (
        <svg viewBox="0 0 55 44" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white">
          {/* ... You can paste the full GARDEN BED icon path here */}
          <path d="M8.25 19.25C11.2836 ..." fill="white" />
          {/* Trimmed for brevity */}
        </svg>
      )
    }
